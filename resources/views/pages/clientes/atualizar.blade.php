...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Produtos editar</h1>
</div>

<form class="form" action="{{ route('produto.atualizar', $editarProduto->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Nome</span>
        <input type="text" class="form-control @error('nome') is-invalid @enderror" value="{{ isset($editarProduto->nome) ? $editarProduto->nome : old('nome') }}"
      ...
      <div class="input-group mb-3">
        ...
        <input class="form-control @error('valor') is-invalid @enderror" value="{{ isset($editarProduto->nome) ? $editarProduto->valor : old('valor') }}"
